...
public class Hue : MonoBehaviour
{
    ...
    private string ipAdress = "10.163.65.54";
    ...
    private void Start()
    {
        ...
        {
            string loadedIpAddress = PlayerPrefs.GetString("IpAdress");
            ipAdress = loadedIpAddress;
        }
    }
    ...
    public void changeIPAdress(string adress)
    {
        ipAdress = adress.ToString();
        PlayerPrefs.SetString("IpAdress", ipAdress);
        PlayerPrefs.Save();
        Debug.Log("Changed and saved new IP-Address: " + ipAdress);
    }
